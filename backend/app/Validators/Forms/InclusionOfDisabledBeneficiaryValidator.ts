...
export default class InclusionOfDisabledBeneficiaryValidator {
  ...
  public schema = schema.create({
    ...
    invalidez: schema.string(),
    invalidezDefinitiva: schema.string(),
    cid: schema.string(),
  ...
  public messages = {
    ...
    'invalidez.required': 'invalidez não informada!',
    'invalidezDefinitiva.required': 'Invalidez definitiva não informada!',
    'cid.required': 'CID não informado!',
    'logradouro.required': 'Logradouro não informado!',
    'numero.required': 'Numero da residência não informado!',
    'complemento.required': 'Complemento não informado!',
