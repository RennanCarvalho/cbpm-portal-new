...
const SpouseExclusion = (props: UserProps) => {
  const {
    register,
    handleSubmit,
    reset,
    ...
    try {
      {
        await api({
          method: 'post',
          url: '/user/forms/spouse-exclusion',
          data: formData,
          headers: {
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)}>
        <FormHeader title={'EXCLUSÃO DE CÔNJUGE/ENTEADO(A)'} attachment={'G'} />
...
Assistência Médico–Hospitalar (AMH) da CBPM. O fim do casamento extingue este direito.
            </Text>
          </Box>
          ...
          >
            <Text>
            2. Com o término do casamento, para a exclusão de cônjuge, o(a) PM contribuinte deve informar por meio de requerimento à CBPM,
fornecendo cópia da decisão judicial de divórcio com trânsito em julgado ou a Certidão de Casamento com a averbação de divórcio.
            </Text>
          </Box>
          ...
          >
            <Text>
            3 Com a o a interrupção/dissolução da União Estável, O PM Contribuinte deve solicitar por meio de requerimento à CBPM, a exclusão
da(o) companheira(o). Neste caso deve relacionar no requerimento 01 (uma) testemunha que comprove a dissolução da união estável.
A testemunha não pode ser parente e nem ter o mesmo endereço.
            </Text>
          </Box>
...
de União Estável devidamente registrado em Cartório de Registro de Títulos e Documentos, ou mediante apresentação de nova
Certidão de Casamento com outra pessoa.
            </Text>
          </Box>
          <Box
            border="1px"
          ...
          >
            <Text>
            5. Com o falecimento, O PM Contribuinte deve solicitar por meio de requerimento à CBPM, a exclusão da(o) cônjuge ou companheira(o),
mediante apresentação da Certidão de Óbito.
          ...
          >
            <Text>
            6. Filhos naturais havidos em comum não podem ser excluídos, pois são beneficiários obrigatórios e assim permanecerão até completar
21 anos de idade, e os inválidos, que serão assistidos enquanto perdurar a invalidez, conforme o Artigo 34, da Lei Estadual Nº 452/74.
          ...
          >
            <Text>
            7. Filhos por afinidade devem ser excluídos, pois conforme Nº 1, do parágrafo 2º, do Artigo 34, da Lei Estadual Nº 452/74, equiparam–
se aos filhos legítimos enquanto durar o casamento ou a união estável. Desta forma, devido a exclusão da(o) cônjuge, os enteados
eventualmente inscritos na CBPM, devem ser abaixo relacionados e excluídos. 
          ...
          >
            <Text>
            8. Cópia simples dos documentos legais que contenham o n º do RG, do CPF ou do CIN (Carteira de Identidade Nacional) do(a) militar contribuinte.
            </Text>
          </Box>
        ...
        <Box w="100%">
          ...
          <SimpleGrid columns={{ base: 1, sm: 2, md: 3, lg: 4 }}>
            ...
            <FormShowUserData formLabel={'RG/CIN'} userProps={props.rg + props.rgdg} />
          ...
          <Box mb="3rem">
            <Box
              ...
              borderRadius="none"
            >
              IDENTIFICAÇÃO – ( ) EX–CÔNJUGE ( ) EX-COMPANHEIRA(O)
            </Box>
            ...
            <SimpleGrid columns={{ base: 1, sm: 2, md: 3, lg: 4 }}>
              ...
              <FormControl>
                ...
                >
                  ...
                  <option value={7}>FILHO(A) POR AFINIDADE</option>
                </Select>
              </FormControl>
            </SimpleGrid>
          ...
          <Box mb="3rem">
                      <Box
                        ...
                        borderRadius="none"
                      >
                        TESTEMUNHA (em caso de interrupção/dissolução da União Estável)
                      </Box>
        ...
        <div>
          ...
          <Stack align="flex-start">
            <Text>
            Requeiro a exclusão da(o) ex-cônjuge/ ex-companheira(o), acima identificada(o), do rol
de beneficiários do regime de Assistência Médico–Hospitalar (AMH) da CBPM, com fundamento no Inciso
I, do Artigo 34, da Lei Estadual Nº 452/74, em razão do fim do casamento/união estável comprovado
mediante documentação apresentada:
            </Text>

            <RadioGroup defaultValue="Certidão de casamento com averbação de divórcio">
              <VStack align="flex-start" ml={10}>
                <Radio
                  {...register('tipoDocumento')}
                  value="Certidão de casamento com averbação de divórcio"
                >
                ...
                <Radio
                  {...register('tipoDocumento')}
                  value="Cópia da decisão judicial de divórcio com trânsito em julgado"
                >
                  Cópia da Decisão Judicial de Divórcio com trânsito em julgado
                </Radio>

                <Radio
                  {...register('tipoDocumento')}
                  value="Cópia do Instrumento Particular de Dissolução de União Estável"
                >
                  Cópia do Instrumento Particular de Dissolução de União Estável
                </Radio>

                <Radio
                  {...register('tipoDocumento')}
                  value="Cópia da Certidão de Óbito"
                >
...
apresentando, para confirmação, uma testemunha<br />
<br />
Havendo enteado(a)(s) inscritos(as), requeiro a exclusão dos acima identificados, com
fundamento no nº 1, do parágrafo 2º, do Artigo 34, da Lei Estadual Nº 452/74. <br /><br />
Fico ciente que até a data de processamento da exclusão da(o) ex-cônjuge / excompanheiro(a) e enteados do sistema de cadastro de rol de beneficiários da CBPM, haverá o desconto
no código 080018 – coparticipação financeira nas eventuais despesas de atendimentos ambulatoriais,
hospitalares e de obstetrícia até então realizados, nos termos do parágrafo 3º, do artigo 30, da Lei nº
452/74, sendo que a partir da referida data, a(o) ex-cônjuge / ex-companheira(o) não mais tem direito a
cobertura de AMH do regime da CBPM com a Cruz Azul e estabelecimentos credenciados. Esta regra
também se aplica aos enteados, quando houver.
          </Text>
          <br />
...
Disciplinar da Polícia Militar do Estado de São Paulo.
        ...
        <br />
        <Flex justify="center" w="100%" mb="2rem">
          <Box mb="4rem" flexWrap="wrap" w="75%">
            <Box fontWeight="bold" border="1px" textAlign="center" bg="gray.500">
      ...
      <Grid templateColumns="repeat(3, 1fr)" >
        ...
        {/* Linha 2 */}
        <Text>(     ) Cópia da Certidão de Casamento com averbação de divórcio.</Text>
        <Text>(     ) Cópia da Decisão Judicial de Divórcio com trânsito em julgado.</Text>
        <Text>(     ) Cópia do Instrumento Particular de Dissolução de União Estável.</Text>

        {/* Linha 3 */}
        <Text>(     ) Cópia da Certidão de Óbito.</Text>
        <Text></Text>
        <Text></Text>
      </Grid>
    </Box>
        ...
        >
          <Button
            ...
            borderRadius="3xl"
            _hover={{ color: 'none' }}
            onClick={() => downloadDocument('exclusao-de-conjuge')}
          >
            Baixar Preenchido
          </Button>
        ...
        <Box my={16}  display={'Flex'} alignItems="center" flexDirection={'column'}>
          <Heading as={'h1'} size={'md'}>
            {displayFileName.length } de 2 arquivo(s) anexado(s) - quantidade mínima necessária:
          </Heading>
          <UnorderedList ms={16} >
