...
const InclusionOfChildrenAndStepchildren = (props: UserProps) => {
  const {
    register,
    handleSubmit,
    reset,
    ...
    try {
      {
        await api({
          method: 'post',
          url: '/user/forms/inclusion-children-and-stepchildren',
          data: formData,
          headers: {
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)}>
        <FormHeader title={'INCLUSÃO DE FILHOS E ENTEADOS'} attachment={'C'} />

        <Box mb="4rem" flexWrap="wrap" w="100%">
          <Box fontWeight="bold" border="1px" textAlign="center" bg="gray.500">
            ORIENTAÇÕES E DOCUMENTOS COMPROBATÓRIOS - FILHO(S)
          </Box>
          ...
          >
            <Text>
              1. Conforme Inciso II, bem como, no parágrafo 2º, do Artigo 34, da Lei Estadual Nº 452/74, filhos(as), naturais ou por vínculo de afinidade,
              menores de 21 anos de idade, são beneficiários(as) obrigatórios(as) do regime de Assistência Médico-Hospitalar (AMH) da CBPM e
              devem ser inscritos(as) ou ter seus dados atualizados, por meio do presente requerimento, assinado pelo(a) contribuinte ou seu
              representante legal, anexando documentos relacionados nos tópicos abaixo.
            </Text>
          </Box>
          ...
          >
            <Text>
              2. Todos os documentos ora solicitados, devem ser anexados ao presente requerimento e entregues conjuntamente, pois resguardam
              direitos e garantias do próprio contribuinte e dos seus beneficiários, preservando a legalidade e integralidade dos registros.
            </Text>
          </Box>
          ...
          >
            <Text>
              3. Cópia simples da Certidão de Nascimento, emitida em Cartório (com data de atualização inferior a 6 (seis) meses para os filhos a partir de 15 anos bem como documentos legais que contenham o n º do RG, do CPF ou do CIN (Carteira de Identidade Nacional) do(a) referido(a) filho(a) a ser inscrito(a). 
            </Text>
          </Box>
          <Box
            border="1px"
          ...
          >
            <Text>
              4. Cópia do último demonstrativo de pagamento (holerite), onde conste a contribuição para a CBPM, bem como documentos legais que contenham o n º do RG, do CPF ou do CIN (Carteira de Identidade Nacional) do(a) PM contribuinte.
            </Text>
          </Box>
          ...
          >
            <Text>
              5. Para fins de inclusão de filhos(as) por afinidade, apresentar os mesmos documentos exigidos para os filhos(as) naturais, pois conforme
              Número 1, do parágrafo 2º, do Artigo 34, da Lei Estadual Nº 452/74, os(as) filhos(as) por afinidade equiparam-se aos filhos naturais
              enquanto durar o casamento ou união estável, sendo que no caso de dissolução do referido casamento ou da união estável, filhos(as)
              por afinidade perderão o benefício.
            </Text>
          </Box>
          ...
          >
            <Text>
              6. Ainda, para fins de inclusão de filhos (as) por afinidade, o pai ou a mãe que seja o(a) cônjuge ou companheira(o) do(a) contribuinte
              CBPM, deve estar com o cadastro devidamente efetivado no quadro de beneficiários(as) da CBPM.
            </Text>
          </Box>
          ...
          >
            <Text>
              7. Para o filho(a) natural ou por afinidade com invalidez, posteriormente à sua inclusão como beneficiário(a), o Contribuinte deve elaborar
              requerimento específico na CBPM (formulário próprio) para ter o(a) filho(a) inscrito(a) também como beneficiário(a) inválido(a),
              devendo o(a) referido(a) dependente ser submetido(a) à perícia no Centro Médico da Polícia Militar, conforme determina o Inciso II, do
              Artigo 34, da Lei Estadual Nº 452/74, onde será atestada formalmente a enfermidade (CID) correspondente à necessidade especial.
            </Text>
          </Box>
        </Box>
        ...
        <div>
          ...
          <br />
          <Text>
            Requeiro a inclusão/atualização de dados, dos(as) filhos(as) (naturais ou por vínculo de
            afinidade nos termos dos Artigos 1.593 e 1.595 do Código Civil) acima qualificados(as), como
            beneficiários(as) do regime de Assistência Médico-Hospitalar (AMH) da CBPM, com fundamento nos
            Incisos II e no parágrafo 2º, do Artigo 34, da Lei Estadual Nº 452/74.
          ...
          <Text>
            ...
            despesas de atendimentos ambulatoriais, hospitalares e de obstetrícia, nos termos do parágrafo 3º, do
            artigo 30, da Lei nº 452/74.
            <br />
            Tenho ciência que a dissolução do casamento/união estável gera a perda automática do
            direito ao uso da AMH/CBPM por parte de ex-cônjuge, ex-companheiro(a) e filhos por afinidade.

          </Text>

          <br />
          <Text>
            Caso ocorra alteração, ou dissolução do Casamento/união estável, comprometo-me a
            comunicar formalmente à CBPM, apresentando cópia da decisão judicial de divórcio com trânsito em
            julgado e/ou a Certidão de Casamento com a averbação de divórcio e demais documentos
            comprobatórios.
          </Text>
          <br />
          ...
          <Text>
            ...
            consentimento do contribuinte e dos beneficiários aqui relacionados, para o tratamento dos presentes
            dados pela CBPM, para fins de AMH, no que preconiza a Lei Estadual Nº 452/74 e demais legislação
            vigente. Entende-se como tratamento de dados e consentimento o que está definido nos Incisos X e XII
            do Artigo 5º da Lei Federal Nº 13.709/18, conforme a seguir transcrito:
          </Text>
          <br />
  ...
  <Grid templateColumns="repeat(2, 1fr)" >
    {/* Filho 1 */}
    <Box>
      <Text>1) (   ) Filho(a) natural  (   ) por afinidade</Text>
      <Text ml={6}>(   ) Certidão de nascimento</Text>
      <Text ml={6}>(   ) RG/CPF</Text>
      <Text ml={6}>(   ) CIN</Text>
    </Box>

    {/* Filho 2 */}
    <Box>
      <Text>2) (   ) Filho(a) natural  (   ) por afinidade</Text>
      <Text ml={6}>(   ) Certidão de nascimento</Text>
      <Text ml={6}>(   ) RG/CPF</Text>
      <Text ml={6}>(   ) CIN</Text>
    </Box>
        ...
        >
          <Button
            ...
            borderRadius="3xl"
            _hover={{ color: 'none' }}
            onClick={() => downloadDocument('inclusao-de-filhos-e-enteados')}
          >
            Baixar Preenchido
          </Button>
...
export default InclusionOfChildrenAndStepchildren;
