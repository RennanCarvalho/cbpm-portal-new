  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)}>
        <FormHeader
          title={'INCLUSÃO DE MENOR SOB GUARDA – TUTELA – CURATELA'}
          attachment={'E'}
        />
        ...
        <Box mb="4rem" flexWrap="wrap" w="100%">
          ...
          >
            <Text>
            1. Conforme nº 2 e 3, do parágrafo 2º, do Artigo 34, da Lei Estadual Nº 452, de 02 de outubro de 1974, os menores sob Guarda Judicial, bem
como os menores sob Tutela e Curatela, os quais comprovadamente vivam sob a dependência econômica do contribuinte, equiparam–se
aos filhos previstos no Inciso II, do artigo 34, da mesma Lei, ora referida. Para tanto, são necessários os documentos relacionados nos tópicos
seguintes, e ao final, assinado pelo(a) contribuinte ou seu representante legal
            </Text>
          </Box>
...
e dos seus beneficiários, preservando a legalidade e integralidade dos registros.
          ...
          >
            <Text>
            3. Cópia do último demonstrativo de pagamento (holerite), onde conste a contribuição para a CBPM e bem como documentos legais que contenham o n º do RG, do CPF ou do CIN (Carteira de Identidade Nacional) do(a) PM contribuinte.
          ...
          >
            <Text>
            4. Apresentar os Termos que comprovem a Guarda Judicial, Tutela ou Curatela do(a)(s) menor(es) de idade.
            </Text>
          </Box>
          ...
          >
            <Text>
            5. Cópia simples da Certidão de Nascimento (com emissão inferior a 6 meses, para os maiores de 12 anos), bem como documentos legais que contenham o n º do RG, do CPF ou do CIN (Carteira de Identidade Nacional) do(a) menor dependente. 
            </Text>
          </Box>
          ...
          >
            <Text>
              6.  Para fins de comprovação de dependência econômica, apresentar pelo menos 02 (dois) dos documentos relacionados a seguir, com
parâmetro no artigo 15 do Decreto Estadual nº 52.860, de 02 de abril de 2008:
            </Text>
            ...
            <UnorderedList styleType="none" spacing={1}>
              ...
              <ListItem>
              h. Declaração e Comprovante de pagamento da escola do dependente por parte do contribuinte
              </ListItem>
            </UnorderedList>
          </Box>
          ...
          >
            <Text>
              7. Para a manutenção do benefício a menores sob guarda judicial, tutela e curatela que atingirem a maioridade legal e que apresentem a
condição de invalidez ou de incapacidade civil, e assim continuarem vivendo sob a dependência econômica do(a) contribuinte, este(a) deverá
incluí-lo(a) como Beneficiário(a) com Invalidez, utilizando o Formulário respectivo.
            </Text>
          </Box>
        </Box>
        ...
        <Box w="100%">
          ...
          <Box mb="3rem">
            <Box
              ...
              borderRadius="none"
            >
              DADOS PESSOAIS – MENOR SOB GUARDA/TUTELA/CURATELA
            </Box>
...
(AMH) da CBPM, com fundamento no parágrafo 2º, do Artigo 34, da Lei Estadual Nº 452/74, do(a) menor
ora qualificado(a), que se encontra sob minha dependência econômica.<br /><br />
<Stack align="flex-start">
            ...
            <RadioGroup defaultValue="GUARDA JUDICIAL">
              <VStack align="flex-start" ml={10}>
                <Radio {...register('tipoDocumento')} value="GUARDA JUDICIAL">
                  Guarda Judicial
                </Radio>
...
artigo 30, da Lei nº 452/74.<br /><br />
Caso ocorra alteração nas condições de guarda, tutela ou curatela constantes desta
declaração, comprometo–me a comunicar formalmente a CBPM, apresentando cópia da documentação
pertinente.<br /><br />
...
dados pessoais para uma finalidade determinada</Text>
        ...
        <br/>
        <Text>
          <Text fontWeight="700" textAlign="center">Declaração</Text><br /><br />
        Eu, __________________________________________, CPF nº _________________ comprometome a comunicar formalmente com a CBPM apresentando cópia de decisão Judicial e demais
documentos probatórios em caso de prorrogação do Termo de Guarda e Responsabilidade a
contar de ___/____/20____.
Comprometo ainda, a arcar totalmente com as despesas médicas que porventura ocorram após o
dia _____/_____/20____, caso não seja prorrogado o Termo de guarda.
  ...
  <Grid templateColumns="repeat(2, 1fr)" >
    ...
    {/* Linha 4 */}
    <Text>(   ) Comprovante Dependência.</Text>
    <Text>(   ) Termo Guarda/Tutela/Curatela.</Text>
