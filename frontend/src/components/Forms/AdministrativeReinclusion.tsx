...
const AdministrativeReinclusion = (props: UserProps | any) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  async function onSubmit(data: any): Promise<void> {
    ...
    formData.append('tipoContribuinte', data.tipoContribuinte);
    ...
    try {
      await api({
        method: 'post',
        url: '/user/forms/administrative-reinclusion',
        data: formData,
        headers: {
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} style={{ width: '100%' }}>
        <FormHeader
          title={'REQUERIMENTO PARA REINCLUSÃO À CONDIÇÃO DE CONTRIBUINTE'}
          attachment={'A'}
          isDeclararion={false}
        />
        ...
        <Box w="100%">
          ...
          <SimpleGrid columns={{ base: 1, sm: 2, md: 2, lg: 2 }}>
            <FormControl>
              ...
              <Input
                defaultValue={
                  props.matricula == '' ? props.identidade : props.matricula
                }
        ...
        <Flex direction="column">
          <Text mb={3}>
            ...
            supra qualificado(a), requeiro à CBPM, de acordo com os termos da
            Lei nº 452/74 e suas alterações, especialmente as dispostas no
            Parágrafo único, do Artigo 32, acrescentado pela Lei Complementar nº
            1.353, de 10 de janeiro de 2.020, a reinclusão à condição de
            contribuinte e, para tanto, declaro estar ciente das exigências
            previstas no caput do Artigo 32 desta mesma Lei e, também, que devo
            cumprir os prazos das carências, conforme segue, para mim (nos casos
            de pensionista) e para meus beneficiários, dos quais seguirá
            preenchida a Declaração de Saúde:
          </Text>

          <UnorderedList ml={20} mb={3}>
            <ListItem>
            ...
            <ListItem>300 (trezentos) dias, para partos a termo, e </ListItem>
            <ListItem>
          ...
          <Text mb={10}>
            Estou ciente de que, na reinclusão como contribuinte obrigatório,
            ocorrerá o desconto no código 070018 em folha de pagamento,
            correspondente ao valor de 2% (se militar da ativa ou reserva), e de
            1% (se pensionista) do valor da pensão, nos termos do artigo 31, da
            Lei nº 452/74, bem como o desconto no código 080018 – coparticipação
            financeira nas despesas de atendimentos ambulatoriais, hospitalares
            e de obstetrícia, nos termos do § 3º, do artigo 30, da Lei nº
            452/74.
          </Text>
        </Flex>

        <Flex justify="space-around" w="100%" mb="2rem">
          <VStack>
            <Text>
              ____________________, __________ de __________ de 20______
            </Text>
            <Text>
              <b>Local e data</b>
            </Text>
          ...
          <VStack>
            ...
            <Text>
              <b>Assinatura do(a) requerente</b>
            </Text>
            <Text>
              <br />
              Nome: ___________________ CPF: _________________________
            </Text>
          </VStack>
        </Flex>
      ...
      <Grid templateColumns="repeat(2, 1fr)">
        {/* Linha 1 */}
        <Text>(   ) Holerite do requerente (último)</Text>
        <Text>
          (   ) Documento com RG / CPF  ou  (   ) CIN
        </Text>

        {/* Linha 2 */}
        <Text>(   ) Documento funcional</Text>
        ...
        <Box mt={5} mb={10} fontWeight="700" textAlign="center">
          <Text>
        ...
        >
          <Button
            ...
            borderRadius="3xl"
            _hover={{ color: 'none' }}
            onClick={() => downloadDocument('reinclusao-administrativa ')}
          >
            Baixar Preenchido
          </Button>
