...
import { MedicalExpenseStatementPDF } from '../../components/PrintPDF/MedicalExpenseStatementPDF';
import { setupAPIClient } from '../../services/setupAPIClient';
import InputMask from 'react-input-mask';
import Link from '../Link';
import MedicalExpenseStatementTableData from './MedicalExpenseStatementTableData';
...
const MedicalExpenseStatement = ({ title }: Title) => {
  ...
  async function handleSearch(payload: SearchData): Promise<void> {
    setLoad(false);
    try {
      const response = await api.get('/user/medical-expense-extract', {
        params: {
  ...
  return (
    <VStack>
      ...
      {data ? <MedicalExpenseStatementTableData {...data} /> : ''}
      <VStack><Text>
        <br />
        <br />
