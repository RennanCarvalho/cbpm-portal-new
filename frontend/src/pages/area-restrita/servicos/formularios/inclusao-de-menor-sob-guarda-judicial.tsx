...
import InclusionOfMinorInJudicialCustodyComponent from '../../../../components/Forms/InclusionOfMinorInJudicialCustody';
...
const InclusionOfMinorInCustody = (
  ...
  return (
    <Fragment>
      <Header />
      <InclusionOfMinorInJudicialCustodyComponent {...props} />
    </Fragment>
  );
};
